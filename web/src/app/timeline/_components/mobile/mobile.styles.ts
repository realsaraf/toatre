...
export const styles: Record<string, React.CSSProperties> = {
  ...
  timelineRibbon: {
    ...
    background:
      "linear-gradient(180deg, rgba(231,177,95,0) 0%, rgba(226,170,83,0.34) 18%, rgba(222,161,70,0.38) 52%, rgba(222,161,70,0) 100%)",
    borderRadius: 999,
    boxShadow: "0 0 0 0.5px rgba(255,255,255,0.34)",
    opacity: 0.72,
    pointerEvents: "none",
    zIndex: 0,
  },
