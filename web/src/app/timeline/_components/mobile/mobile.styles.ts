...
export const styles: Record<string, React.CSSProperties> = {
  ...
  sectionTitle: {
    ...
    color: "#6B7280",
    marginBottom: 8,
    paddingLeft: "clamp(56px, 16vw, 96px)",
  },
  sectionTitleCompact: {
    fontSize: 12,
    marginBottom: 8,
  ...
  timelineRow: {
    display: "grid",
    gridTemplateColumns: "clamp(48px, 13vw, 66px) 14px minmax(0, 1fr)",
    gap: "clamp(7px, 2.4vw, 10px)",
    alignItems: "stretch",
  },
  timelineRowCompact: {
    gridTemplateColumns: "36px 10px minmax(0, 1fr)",
    gap: 7,
  },
  timeRailColumn: {
    paddingTop: 10,
  ...
  toatCard: {
    ...
    minHeight: "clamp(76px, 20vw, 92px)",
