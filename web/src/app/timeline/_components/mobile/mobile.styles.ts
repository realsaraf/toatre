...
export const styles: Record<string, React.CSSProperties> = {
  ...
  datePill: {
    ...
    padding: "0 15px",
    borderRadius: 20,
    border: "1px solid rgba(233,229,221,0.96)",
    ...
    fontSize: 15,
    fontWeight: 600,
    boxShadow: "0 10px 24px rgba(26,35,56,0.08)",
  ...
  toatCountPill: {
    ...
    fontWeight: 500,
    padding: "10px 18px",
    boxShadow: "0 10px 25px rgba(25,35,55,0.06)",
  },
  clearHeroCard: {
    position: "relative",
    minHeight: 132,
    ...
    boxShadow: "0 14px 36px rgba(36,24,82,0.08)",
  ...
  clearHeroCheckWrap: {
    ...
    display: "grid",
    placeItems: "center",
    background: "radial-gradient(circle, rgba(234,183,108,0.20), rgba(234,183,108,0.06) 48%, rgba(234,183,108,0) 70%)",
  },
  clearHeroCheck: {
    width: 56,
    height: 56,
    ...
    fontWeight: 900,
    background: "#fff",
    border: "3px solid #C27A12",
    boxShadow: "0 12px 24px rgba(194,122,18,0.24)",
  },
  ...
  timelineRibbon: {
    ...
    background:
      "linear-gradient(180deg, rgba(238,185,111,0) 0%, rgba(234,183,108,0.45) 18%, rgba(232,174,95,0.5) 52%, rgba(230,169,88,0) 100%)",
    borderRadius: 999,
  ...
  railDot: {
    ...
    boxShadow: "0 4px 12px rgba(194,122,18,0.26)",
    flexShrink: 0,
    zIndex: 1,
  },
  railDotCompact: {
  ...
  toatCard: {
    ...
    minHeight: "clamp(92px, 23vw, 106px)",
    padding: "clamp(12px, 3.3vw, 15px) clamp(12px, 3.8vw, 17px)",
    borderRadius: "clamp(20px, 5.2vw, 24px)",
    background: "linear-gradient(180deg, rgba(255,255,255,0.97), rgba(255,255,255,0.9))",
    border: "1px solid rgba(236,233,227,0.95)",
    boxShadow: "0 12px 28px rgba(36,24,82,0.07)",
    cursor: "pointer",
    outline: "none",
  },
  toatCardCompact: {
  ...
  timelineIconPanel: {
    width: "clamp(44px, 11.5vw, 58px)",
    height: "clamp(44px, 11.5vw, 58px)",
    borderRadius: "clamp(13px, 3.4vw, 16px)",
  },
  ...
  statusPill: {
    ...
    justifyContent: "center",
    gap: 6,
    minHeight: "clamp(36px, 8.4vw, 40px)",
    minWidth: "clamp(94px, 20.5vw, 114px)",
    padding: "0 10px",
    border: "1px solid transparent",
    borderRadius: "clamp(13px, 3.6vw, 15px)",
